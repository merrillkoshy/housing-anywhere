					...
					<div className="d-flex justify-content-center align-items-center">
						<p>
							<img
								...
								alt={"linkedin-logo"}
							/>
							<a href={"https://www.linkedin.com/in/merrill-koshy-thomas"}>
						...
						<p>
							<img
								...
								alt={"linkedin-logo"}
							/>
							<a href={"https://merrillkoshy.github.io"}>Portfolio</a>
						</p>
					</div>
					<div
                ...
                d-none mx-5"
					>
						...
						<a
							...
							className="mx-2"
						>
							<strong>Front End : </strong>/merrillkoshy/housing-anywhere
						</a>
					</div>
					<div
						className="justify-content-center d-lg-flex d-xl-flex d-xxl-flex
                d-none mx-5"
					>
						...
						<a
							...
							className="mx-2"
						>
							<strong>Back End : </strong>/merrillkoshy/ha-server
						</a>
					</div>
				</div>
			</footer>
